...
case class GenerateUserReport()
case class GenerateBookReport()
case class GenerateTransactionReport()
case class GenerateOverdueReport()
case class GenerateFineReport()
